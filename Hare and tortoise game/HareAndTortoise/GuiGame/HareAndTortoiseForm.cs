...
namespace GuiGame {
	...
	public partial class HareAndTortoiseForm : Form {
		...
		private void SetupTheGui() {
			...
			Trace.Listeners.Add(new ListBoxTraceListener (listBoxListener));
		...
		private static void MapSquareNumToScreenRowAndColumn(int squareNumber, out int rowNumber, out int columnNumber) {
			rowNumber = squareNumber/(NUM_OF_COLUMNS);
			columnNumber = squareNumber%(NUM_OF_COLUMNS);
		}
        ...
        private void rollDiceButton_Click(object sender, EventArgs e)
        {
            ...
            Trace.WriteLine(string.Format("Player {0}: dices {1}", hareAndTortoiseGame.CurrentPlayer.Name, (hareAndTortoiseGame.Die1Value + hareAndTortoiseGame.Die2Vlue)));
            hareAndTortoiseGame.PlayerMove();//Move player
            Trace.WriteLine(string.Format("player {0}: move from {1} to {2}", hareAndTortoiseGame.CurrentPlayer.Name, hareAndTortoiseGame.CurrentPlayer.Location.Number - (hareAndTortoiseGame.Die1Value + hareAndTortoiseGame.Die2Vlue), hareAndTortoiseGame.CurrentPlayer.Location.Number));
            ...
            hareAndTortoiseGame.NextPlayer();
        ...
        private void HareAndTortoiseForm_ResizeEnd(object sender, EventArgs e)
        {
            ResizeGameBoard();
        }
